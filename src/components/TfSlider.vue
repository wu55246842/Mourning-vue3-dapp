                                ...
                                <div class="slider-inner flex home-1">
                                    <div class="slider-content">
                                        ...
                                        <div class="button-slider">
                                            <a href="explore-1.html" class="sc-button btn-bordered-white style letter "><span>MORE STORY</span></a>
                                            <a href="create-item.html" class="sc-button btn-bordered-white style file"><span>Remembrance Now</span></a>
                                        </div>
                                    </div>
                    ...
                    <swiper-slide :key="i" v-for="(s,i) in contents">
                            <div class="sc-product-item">
                                <div class="product-img ">
                                    ...
                                    <!-- <div class="countdown">
                                        <span class="js-countdown">{{s.name}}</span>
                                    </div> -->
                                    <!-- <a href="#" data-toggle="modal" data-target="#popup_bid" class="sc-button style letter">
                                        <span>send remembrance</span>
                                    </a> -->
                                    <!-- <label><span>send remembrance</span></label> -->
                                </div>
