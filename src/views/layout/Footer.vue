                ...
                <div class="row d-flex align-items-center">
                    <div class="col-lg-4">
                        <div class="footer-box-layout1">
                            <div class="copyright">© 2022 bbloger. All Rights <a href="http://www.bootstrapmb.com/" title="bootstrapmb">Reserved</a>.</div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="footer-box-layout1">
                            <div class="footer-logo">
                                <a href="index.html"><img src="../../assets/img/laowudi_fish.png" alt="logo"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
